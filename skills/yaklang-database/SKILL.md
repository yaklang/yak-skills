...
完整示例：[example-sqlite-crud.yak](example-sqlite-crud.yak)
...
完整示例（KV + Payload，带清理）：[example-kv-and-payload.yak](example-kv-and-payload.yak)
...
go run common/yak/cmd/yak.go skills/yaklang-database/example-sqlite-crud.yak
go run common/yak/cmd/yak.go skills/yaklang-database/example-kv-and-payload.yak
```
